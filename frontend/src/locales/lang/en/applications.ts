export default {
  ...
  see: {
    ...
    addressProxy: 'Address Of Staking Proxy',
    nodeEthereumUrl: 'NodeEthereumUrl',
  ...
  new: {
    addTitle: 'New {title} Service',
    name: 'Name',
    namePlaceholder: 'Enter your service name',
    leaseTerm: 'Lease Term',
    leaseTermPlaceholder: 'Enter your lease days',
    selectNodeType: 'Select Node Type',
    selectNodeTypePlaceholder: 'Select the type of node service you need',
    thegraphIndexer: 'Thegrap Indexer',
